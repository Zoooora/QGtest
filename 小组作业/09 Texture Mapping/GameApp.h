...
public:
	...
	enum class ShowMode { WoodCrate, FireAnim, box};
...
private:
	...
	ComPtr<ID3D11InputLayout> VertexPosHWNormalTex;
	...
	ComPtr<ID3D11ShaderResourceView> m_pFlare;
	ComPtr<ID3D11ShaderResourceView> m_pFlareAlpha;
	ComPtr<ID3D11ShaderResourceView> m_pWoodCrateback;
	ComPtr<ID3D11ShaderResourceView> m_pFlareback;
	ComPtr<ID3D11ShaderResourceView> m_pFlareAlphaback;
	ComPtr<ID3D11ShaderResourceView> fire;
